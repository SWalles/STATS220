...
I took STATS 380 last semester so I was able to split the responses and clean the data a bit. I made a mistake to use commas in the question. When I split the responses I got some that I did not want like "eg. Camping", so I had to remove them.
...
Using knowledge from STATS 380 I was able to separate different choices by an individual as well as remove the examples I provided in the question.
...
I believe that I mostly demonstrated creativity with regards to the last question on my form. I asked people to describe in one word how they generally felt about social media. I used a regular expression to limit answers to one word of up to 16 characters. I then had to find a way to display this information in my report. After doing some research I settled on using the ggwordcloud package to create a word cloud and colour words according to their popularity.

I also applied knowledge I have gained from other courses like STATS 380 to improve the presentation of the data in the analytics section. 

In the interest of full transparency, the css code for this assignment was reused from project 1.
...
As I have declared above I have taken some other statistics courses and have been exposed to R and the tidyverse through those. I am however exited to learn more about the ggplots2 package and creating interesting graphics to visualise data.
